...
blight.units <- read.table('Cache/Blight Units/all.daily.susceptible.calcs.txt', head = TRUE, sep = '\t')

# Create a RESISTANT cultivar model with this data for daily weather data
blight.units <- read.table('Cache/Blight Units/all.daily.resistant.calcs.txt', head = TRUE, sep = '\t')

##### Data for monthly models #####
# Create a SUSCEPTIBLE model with this data for monthly weather data
blight.units <- read.table('Cache/Blight Units/all.monthly.susceptible.calcs.txt', head = TRUE, sep = '\t')

# Create a RESISTANT model with this data for monthly weather data
blight.units <- read.table('Cache/Blight Units/all.monthly.resistant.calcs.txt', head = TRUE, sep = '\t')
